const INVALID_ADDRESS_ALERT =
  "ETH Address contains invalid characters. Please input a" +
  " hexadecimal address and ensure that all characters are alphanumeric.\n";
const INVALID_AMOUNT_ALERT =
  "ETH Amount contains invalid characters. Please input a" +
  " decimal amount and ensure that all characters are numeric.\n";
const INVALID_OTP_ALERT =
  "OTP contains invalid characters. Please input only" +
